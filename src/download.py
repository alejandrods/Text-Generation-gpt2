...
# GPT2LMHeadModel.from_pretrained('jonasmue/cover-letter-gpt2').save_pretrained('./cover-letter-gpt2')
# GPT2Tokenizer.from_pretrained('jonasmue/cover-letter-gpt2').save_pretrained('./cover-letter-gpt2')
